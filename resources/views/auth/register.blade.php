...
<body>
    ...
    <x-auth-session-status class="mb-4" :status="session('status')" />
        ...
        <div class="container-fluid h-custom pt-3">
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-md-9 col-lg-6 col-xl-5 d-flex justify-content-center align-items-center">
                    <img src="img/logo.jpeg" class="img-fluid rounded-1 w-50" alt="Sample image">
                </div>
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-outline mb-4 mt-5">
                            ...
                            <input type="text" id="name" name="name" class="form-control form-control-lg" placeholder="Enter name" />
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="number" id="phone_number" name="phone_number" class="form-control form-control-lg" placeholder="Contoh: 891372673" />
                        ...
                        <div class="d-flex justify-content-between align-items-center text-center text-lg-start mt-4 pt-2">
                            ...
                            <p class="small fw-bold mb-0">Already registered? <a href="{{ route('login') }}" class="link-danger">Login</a></p>
                        </div>
                    </form>
                </div>
            </div>
        </div>
        <div class="footer fixed-bottom d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5 bg-primary">
            <!-- Copyright -->
